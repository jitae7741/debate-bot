...
- 지역 (필수): 한국 인물과 미국 인물을 거의 반반(약 4:4 ~ 5:5) 비율로 섞으세요. 한쪽으로 쏠리지 말 것. 주제가 한국 시장 한정이어도 글로벌 시각의 미국 인물을 최소 3명 이상 포함. 영국·독일·일본·중국 인물 1~2명 추가는 허용.
- 자율주행 분야 인물 최소 1명 필수 포함 (예: 자율주행 회사 임원, 자율주행 안전·정책 전문가, 자율주행 엔지니어링 리더 등). 주제가 자율주행과 직접 관련 없어도 미래 모빌리티 관점 제공을 위해 반드시 한 명 넣을 것.
